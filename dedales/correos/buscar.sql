...
ON (enviados.Folio=recibidos.Folio AND DATEDIFF(enviados.fecha,recibidos.fecha)>-1)
...
*/
\! sudo cp /tmp/relacionados.csv /var/lib/mysql/Reporte_correos/
...
\! cp /tmp/relacionados.csv reportes/
/*
...
\! cp /tmp/enviados_sin_folio_sin_relacionar.csv reportes/
\! cp /tmp/enviados_con_folio_sin_relacionar.csv reportes/
...
\! cp /tmp/recibidos_sin_folio_sin_relacionar.csv reportes/
\! cp /tmp/recibidos_con_folio_sin_relacionar.csv reportes/
