...
class DESEmisor1{
	...
	public static void main(String[] args) {
		...
		if (args.length !=5){
			System.out.println(
				"Este programa requiere de 5 argumentos de línea de mandato: Direccion IP, puerto receptor, clave de cifrado, numero en hexadecimal y opcion para descifrar o cifrar");
		}		
		else{
			try{
